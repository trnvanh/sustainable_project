    ...
    <View style={styles.section}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
          <OfferCard name={item.name} price={item.price} image={item.image} pickupTime={item.pickupTime} distance={item.distance} portionsLeft={item.portionsLeft} />
          </TouchableOpacity>
        )}
      />
    </View>
