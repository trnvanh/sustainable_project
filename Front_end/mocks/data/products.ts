...
export const mockHistoryOrders = [
  ...
  export const mockOtherProducts = [
    {
      id: '401',
      ...
      location: {restaurant: 'Rax Pizzabuffet', address: 'Pietilänkatu 2, 33720 Tampere'},
      image: veggieBox,
      description: 'A pack of organic almonds, perfect for snacking.',
    },
    {
      id: '402',
      ...
      location: {restaurant: 'Rax Pizzabuffet', address: 'Pietilänkatu 2, 33720 Tampere'},
      image: veggieBox,
      description: 'A loaf of whole wheat bread, fresh and healthy.',
    },
    {
      id: '403',
      name: 'Green Tea',
      ...
      location: {restaurant: 'Rax Pizzabuffet', address: 'Pietilänkatu 2, 33720 Tampere'},
      image: veggieBox,
      description: 'A box of organic green tea bags, refreshing and healthy.',
    },
    {
      id: '404',
      name: 'Dark Chocolate',
      ...
      location: {restaurant: 'Rax Pizzabuffet', address: 'Pietilänkatu 2, 33720 Tampere'},
      image: veggieBox,
      description: 'A bar of dark chocolate, rich in flavor and antioxidants.',
    },
  ]